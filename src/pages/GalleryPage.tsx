...
const galleryData: GalleryItem[] = [
  ...
  {
    id: 'g_2',
    title: 'Modern Pre-Pleated Cocktail Saree',
    category: 'Celebrity & Designer',
    image: '/gallery/img_e0269.jpg',
    sareeType: 'Contemporary Metallic Satin Silk',
  },
  {
    id: 'g_3',
    title: 'Royal Bridal Kanchipuram Box Fold',
    category: 'Bridal & Festive',
    image: '/gallery/img_e1084.jpg',
    sareeType: 'Pure Kanchipuram Pattu',
  },
  {
    id: 'g_4',
  ...
  {
    id: 'g_5',
    title: 'Rose Gold Sheer Organza Pre-Pleat',
    category: 'Celebrity & Designer',
  ...
  {
    id: 'g_6',
    title: 'Festive Crimson Red Silk Drape',
    category: 'Bridal & Festive',
    image: '/gallery/img_e1376.jpg',
    sareeType: 'Heavy Zari Bridal Silk',
  },
  {
    id: 'g_7',
    title: 'Studio Mannequin Pallu Pinning',
  ...
  {
    id: 'g_8',
    title: 'Modern Peach Georgette Pleats',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/img_e1509.jpg',
    sareeType: 'Georgette Pre-Pleated',
  },
  {
    id: 'g_9',
  ...
  {
    id: 'g_11',
    title: 'Studio Ironing & Pin Guard Check',
    category: 'Studio Showcase',
  ...
  {
    id: 'g_12',
    title: 'Royal Emerald Green Pre-Pleat',
    category: 'Pre-Pleated Drapes',
  ...
  {
    id: 'g_13',
    title: 'Celebrity Pearl Embellished Ivory Saree',
    category: 'Celebrity & Designer',
    image: '/gallery/img_e4019.jpg',
    sareeType: 'Modern Pearl Embellished Silk',
  },
  {
    id: 'g_14',
  ...
  {
    id: 'g_15',
    title: 'Teal Blue Pleated Pallu Saree',
    category: 'Pre-Pleated Drapes',
  ...
  {
    id: 'g_16',
    title: 'Celebrity Mauve Designer Drape',
    category: 'Celebrity & Designer',
    image: '/gallery/img_e5560.jpg',
    sareeType: 'Designer Pre-Pleated Drape',
  },
  {
    id: 'g_17',
    title: 'Studio Masterclass Draping Session',
    category: 'Studio Showcase',
  ...
  {
    id: 'g_18',
    title: 'Bridal Sunset Temple Border Silk',
    category: 'Bridal & Festive',
  ...
  {
    id: 'g_20',
    title: 'Mustard Gold Festival Silk Drape',
    category: 'Bridal & Festive',
  ...
  {
    id: 'g_22',
    title: 'Blush Pink Pre-Pleated Georgette',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/qndd2515.jpg',
    sareeType: 'Flowy Georgette Pre-Pleat',
  },
  {
    id: 'g_23',
