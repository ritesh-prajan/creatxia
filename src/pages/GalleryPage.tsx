...
interface GalleryItem {
  id: string;
  title: string;
  category: 'Bridal & Festive' | 'Pre-Pleated Drapes' | 'Studio Showcase';
  image: string;
  sareeType: string;
}
...
const galleryData: GalleryItem[] = [
  {
    id: 'g_1',
    title: 'Bridal Kanchipuram Box Fold',
  ...
  {
    id: 'g_3',
    title: 'Golden Brocade Box Pleating',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/img_e0269.jpg',
    sareeType: 'Heavy Brocade Saree',
  },
  {
    id: 'g_4',
    title: 'Emerald Green Hanger Fold',
    category: 'Pre-Pleated Drapes',
  ...
  {
    id: 'g_5',
    title: 'Maroon Pallu Pinning Precision',
  ...
  {
    id: 'g_6',
    title: 'Pastel Organza Pleat Alignment',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/img_e1371.jpg',
    sareeType: 'Organza Silk',
  },
  {
    id: 'g_7',
    title: 'Festive Yellow Silk Box Drape',
    category: 'Bridal & Festive',
  ...
  {
    id: 'g_8',
    title: 'Studio Mannequin Styling Showcase',
    category: 'Studio Showcase',
    image: '/gallery/img_e1379.jpg',
    sareeType: 'Studio Drapery Art',
  },
  {
    id: 'g_9',
    title: 'Royal Blue Pre-Pleated Saree',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/img_e1509.jpg',
    sareeType: 'Soft Silk Saree',
  },
  {
    id: 'g_10',
    title: 'Reception Gold Thread Saree',
    category: 'Bridal & Festive',
    image: '/gallery/img_e1528.jpg',
    sareeType: 'Reception Silk Drape',
  },
  {
    id: 'g_11',
    title: 'Magenta Silk Waist Fold Setting',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/img_e1547.jpg',
    sareeType: 'Pattu Saree',
  },
  {
    id: 'g_12',
    title: 'Studio Ironing & Pin Guard Process',
    category: 'Studio Showcase',
    image: '/gallery/img_e1661.jpg',
    sareeType: 'Expert Iron & Pinning',
  },
  {
    id: 'g_13',
    title: 'Teal Silk Pallu Step Setting',
    category: 'Pre-Pleated Drapes',
  ...
  {
    id: 'g_14',
    title: 'Designer Tissue Silk Drape',
    category: 'Bridal & Festive',
  ...
  {
    id: 'g_15',
    title: 'Compact Hanger Packaging',
    category: 'Studio Showcase',
    image: '/gallery/img_e4812.jpg',
    sareeType: 'Zero-Crease Hanger Fold',
  },
  {
    id: 'g_16',
    title: 'Violet Pattu Saree Box Pleat',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/img_e5383.jpg',
    sareeType: 'Traditional Pattu Saree',
  },
  {
    id: 'g_17',
    title: 'Celebrity Mauve Drape Showcase',
    category: 'Bridal & Festive',
    image: '/gallery/img_e5560.jpg',
    sareeType: 'Celebrity Style Saree',
  },
  {
    id: 'g_18',
    title: 'Studio Workshop Draping Session',
    category: 'Studio Showcase',
    image: '/gallery/img_e8577.jpg',
    sareeType: 'Academy Masterclass',
  },
  {
    id: 'g_19',
    title: 'Crimson Red Wedding Saree',
    category: 'Bridal & Festive',
    image: '/gallery/img_e8655.jpg',
    sareeType: 'Bridal Red Silk',
  },
  {
    id: 'g_20',
    ...
    sareeType: 'Pre-Pleated Saree Pack',
  },
  {
    id: 'g_21',
    title: 'Mustard Yellow Pallu Pleats',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/kzqq3563.jpg',
    sareeType: 'Traditional Silk',
  },
  {
    id: 'g_22',
    title: 'Copper Zari Silk Drape',
    category: 'Bridal & Festive',
    image: '/gallery/pnra7250.jpg',
    sareeType: 'Copper Zari Saree',
  },
  {
    id: 'g_23',
    title: 'Peach Georgette Pleating',
    category: 'Pre-Pleated Drapes',
    image: '/gallery/qndd2515.jpg',
    sareeType: 'Georgette Silk Saree',
  },
  {
    id: 'g_24',
    title: 'Studio Final Inspection Drape',
    category: 'Studio Showcase',
  ...
  {
    id: 'g_25',
    title: 'Silver Zari Festive Saree',
    category: 'Bridal & Festive',
    image: '/gallery/ykoi7845.jpg',
    sareeType: 'Silver Zari Silk',
  },
];
    ...
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 space-y-10 font-sans animate-fadeIn text-left">
      ...
      <div className="bg-gradient-to-r from-brand-plum via-[#681947] to-brand-rose text-white rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-md">
        ...
        <div className="relative z-10 space-y-4 max-w-2xl">
          ...
          <p className="text-sm md:text-base text-neutral-100 leading-relaxed font-light">
            Explore our portfolio of 25+ real pre-pleated saree transformations, studio ironing perfection, and bridal drape showcases.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-brand-blush/20 pb-4">
        <div className="flex flex-wrap items-center gap-2">
          {['All', 'Bridal & Festive', 'Pre-Pleated Drapes', 'Studio Showcase'].map((cat) => (
            <button
              key={cat}
